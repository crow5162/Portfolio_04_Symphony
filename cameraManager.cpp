...
cameraManager::cameraManager()
{
	...
	_worldImage = IMAGEMANAGER->addImage("worldMap", 6700, 6700);
...
void cameraManager::set_CameraWorldSize(float WorldSizeX, float WorldSizeY)
{
	_cameraWorldSizeX = WorldSizeX;
	_cameraWorldSizeY = WorldSizeY;
}
...
void cameraManager::set_CameraXY(float x, float y, bool fast, bool cameracorrection)
{
	if (fast)
	{
		_cameraX = x - _cameraSizeX / 2.0f;
